...
class OrganizationApi(object):
    ...
    def create_organization_with_http_info(self, organization_id, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(OrganizationCreateResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        body_params = None
        if 'organization_create_request' in local_var_params:
            body_params = local_var_params['organization_create_request']
        # HTTP header `Accept`
        ...
        return self.api_client.call_api(
            ...
            response_type='OrganizationCreateResponse',  # noqa: E501
