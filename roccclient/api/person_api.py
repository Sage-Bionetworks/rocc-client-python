...
class PersonApi(object):
    ...
    def create_person(self, **kwargs):  # noqa: E501
        ...
        :type person_create_request: PersonCreateRequest
    ...
    def create_person_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(PersonCreateResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        body_params = None
        if 'person_create_request' in local_var_params:
            body_params = local_var_params['person_create_request']
        # HTTP header `Accept`
        ...
        return self.api_client.call_api(
            ...
            response_type='PersonCreateResponse',  # noqa: E501
