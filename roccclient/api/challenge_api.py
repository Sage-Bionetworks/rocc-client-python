...
class ChallengeApi(object):
    ...
    def create_challenge(self, challenge_create_request, **kwargs):  # noqa: E501
        ...
        >>> thread = api.create_challenge(challenge_create_request, async_req=True)
        >>> result = thread.get()

        :param challenge_create_request: (required)
        :type challenge_create_request: ChallengeCreateRequest
        ...
        return self.create_challenge_with_http_info(challenge_create_request, **kwargs)  # noqa: E501

    def create_challenge_with_http_info(self, challenge_create_request, **kwargs):  # noqa: E501
        """Add a challenge  # noqa: E501
        ...
        >>> thread = api.create_challenge_with_http_info(challenge_create_request, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ChallengeCreateResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        # verify the required parameter 'challenge_create_request' is set
        if self.api_client.client_side_validation and ('challenge_create_request' not in local_var_params or  # noqa: E501
                                                        local_var_params['challenge_create_request'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `challenge_create_request` when calling `create_challenge`")  # noqa: E501
        ...
        body_params = None
        if 'challenge_create_request' in local_var_params:
            body_params = local_var_params['challenge_create_request']
        # HTTP header `Accept`
        ...
        return self.api_client.call_api(
            ...
            response_type='ChallengeCreateResponse',  # noqa: E501
