...
class GrantCreateResponse(object):
    ...
    def __init__(self, grant_id=None, local_vars_configuration=None):  # noqa: E501
        """GrantCreateResponse - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def grant_id(self):
        """Gets the grant_id of this GrantCreateResponse.  # noqa: E501

        The ID of the grant  # noqa: E501

        :return: The grant_id of this GrantCreateResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GrantCreateResponse):
            return False
