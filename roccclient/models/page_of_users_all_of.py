...
class PageOfUsersAllOf(object):
    ...
    def __init__(self, users=None, local_vars_configuration=None):  # noqa: E501
        """PageOfUsersAllOf - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def users(self):
        """Gets the users of this PageOfUsersAllOf.  # noqa: E501

        An array of Users  # noqa: E501

        :return: The users of this PageOfUsersAllOf.  # noqa: E501
        :rtype: list[User]
        """
        return self._users
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PageOfUsersAllOf):
            return False
