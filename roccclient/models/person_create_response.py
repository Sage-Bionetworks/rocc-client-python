...
class PersonCreateResponse(object):
    ...
    def __init__(self, person_id=None, local_vars_configuration=None):  # noqa: E501
        """PersonCreateResponse - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def person_id(self):
        """Gets the person_id of this PersonCreateResponse.  # noqa: E501

        The ID of the person  # noqa: E501

        :return: The person_id of this PersonCreateResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PersonCreateResponse):
            return False
